  ...
  return (
    <main className="dark:bg-abrandc-dark-blackish bg-white">
      ...
      <main className="dark:bg-abrandc-dark-blackish bg-white container-2 mx-auto space-y-20">
          ...
          <div className="m-auto mt-2 max-w-screen-xxl ">
            ...
            <div className="flex max-w-screen-xxl">
              ...
              <div className="flex-1 flex flex-col items-center justify-center">
                <h1 className="ml-0 text-left text-3xl font-bold text-gray-700 mb-4">
                  Title
                </h1>
                <p className="text-gray-500 text-center text-justify whitespace-pre-line">
                  ...
                  collaborate with diverse businesses aiming to streamline their
                  operations and enhance their productivity. From accounting to
                  store management and beyond, our comprehensive suite of
                  services caters to your unique business needs. Join us to
                  redefine your business strategies, optimize efficiency and
                  drive your business towards prolific growth.
                </p>
              </div>
            </div>
        ...
        <section
          id="pricing"
          className="bg-abrandc-light-grey dark:bg-abrandc-dark-blackish"
        >
