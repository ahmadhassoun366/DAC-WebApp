    ...
    <div className="h-full p-8 flex items-center justify-center ">
      <div className="flex gap-1 w-5/6 h-5/6 drop-shadow-lg rounded bg-abrandc-light-grey dark:bg-abrandc-dark-grey">
        ...
        <div className="lg:w-1/2 lg:pl-20 lg:pr-20  pt-5 pb-5 pl-5 pr-5 flex items-center flex-col justify-center">
          <h1 className="text-center text-3xl font-semibold mb-8 dark:text-white text-abrandc-dark-blackish">Sign in</h1>
          <form>
            <label htmlFor="email" className="dark:text-white text-abrandc-dark-blackish">Email</label>
            <input
              type="email"
              ...
              autoComplete="off"
            />
            <label htmlFor="password" className="dark:text-white text-abrandc-dark-blackish">Password</label>
            <input
              type="text"
